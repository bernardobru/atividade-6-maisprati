    ...
    return (
        <Container id="home">
            <Destaque id="destaque">
                <ImgDestaque src={lotr}></ImgDestaque>
                <H2>Sauron planeja um grande ataque a Minas Tirith, capital de Gondor, o que faz com que Gandalf e Pippin partam para o local na intenção de ajudar a resistência. Frodo, Sam e Gollum seguem sua viagem rumo à Montanha da Perdição para destruir o anel.</H2>
                <DivDestaque>
